...
**Example:** `my-harbor.io/<organization>/build-service`
...
**Convention:** `<server>/<repository>/<Workload Name>-<namespace>`
...
**Convention:** `<server>/<repository>/<Workload Name>-<namespace>-bundle`
...
**Convention:** `<server>/<repository>/<Workload Name>-<namespace>-<source>`
